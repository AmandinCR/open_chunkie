...
%}
% --- q0 = n · H_L on the torus boundary ---
[valL, gradL] = chnk.axissymlap2d.green_modal(srcL, src, origin, mA, all_modes);
...
for ie = 1:neps
    ...
    targC = [rcap; 0.0];
    [valC_L, ~] = chnk.axissymlap2d.green_modal(srcL, targC, origin, mA, all_modes);
...
%}
[valL_t, gradL_t] = chnk.axissymlap2d.green_modal(srcL, targT, origin, mA, all_modes);
